class mazut::cinder::auth (){
  ...
  $password                      = hiera('mazut::cinder_user_password')
  ...
  $roles                         = ['admin']
  $admin_url                     = "http://$controller_admin_host:8776/v1/\$(tenant_id)s"
  $internal_url                  = "http://$controller_priv_host:8776/v1/\$(tenant_id)s"
